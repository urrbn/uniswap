...
describe("Test", function () {
  before(async function () {
    ...
    await this.pop.approve('0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D', ethers.utils.parseEther("1000000"));
  ...
  it('Add liquidityEth', async function (){
    ...
    await this.adapter.addLiquidityETH(this.pop.address, ethers.utils.parseEther('1000'), ethers.utils.parseEther('10'), this.owner.address, { value: ethers.utils.parseEther("10") })
  })
